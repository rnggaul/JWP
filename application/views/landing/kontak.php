<!-- Page Header Start -->
<div class="container-fluid page-header page-header-kontak py-5 mb-5 wow fadeIn" style="background: linear-gradient(rgba(136, 180, 78, .2), rgba(136, 180, 78, .2)), 
	...
	<div class="container text-center py-5">
		...
		<nav aria-label="breadcrumb animated slideInDown">
			<ol class="breadcrumb justify-content-center mb-0">
				...
				<li class="breadcrumb-item text-dark" aria-current="page">Kontak Kami</li>
			</ol>
		</nav>
	</div>
</div>
